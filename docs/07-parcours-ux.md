...
#### 6b. Attente de vérification *(état de l'écran 6, pas un écran de plus)*
...
| Écran | JS initial | Premier affichage utile (3G lente) | Interactif |
|---|---|---|---|
| Accueil vitrine | ≤ 60 Ko | ≤ 1,5 s | ≤ 2,5 s |
| Inscription / OTP | ≤ 120 Ko | ≤ 2,0 s | ≤ 3,0 s |
